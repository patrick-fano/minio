...
replace github.com/go-jose/go-jose/v4 v4.0.4 => github.com/go-jose/go-jose/v4 v4.0.5

replace go.opentelemetry.io/otel/sdk v1.38.0 => go.opentelemetry.io/otel/sdk v1.40.0
